...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID, f"**» {config.MUSIC_BOT_NAME} 𝐌𝐚𝐬𝐬𝐨𝐦 𝐨𝐧𝐞 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 :**\n\n✨ 𝐈𝐝 : `{self.one.id}`\n❄ 𝐍𝐚𝐦𝐞 : {self.one.name}\n💫 𝐔𝐬𝐞𝐫𝐧𝐚𝐦𝐞 : @{self.one.username}"
                )
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Jam_music_updates")
                await self.two.join_chat("roprish")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Jam_music_updates")
                await self.three.join_chat("roprish")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Jam_music_updates")
                await self.four.join_chat("roprish")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Jam_music_updates")
                await self.five.join_chat("roprish")
            except:
                pass
            assistants.append(5)
